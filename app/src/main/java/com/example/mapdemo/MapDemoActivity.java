...
public class MapDemoActivity extends AppCompatActivity implements GoogleMap.OnMapLongClickListener {
    ...
    protected void loadMap(GoogleMap googleMap) {
        ...
        if (map != null) {
            ...
            // Only after map loads correctly
            // Use this only because this implements googlemap.setonmaplonglicklistener
    ...
    public void onMapLongClick(LatLng latLng) {
        Toast.makeText(this, "Long press", Toast.LENGTH_SHORT);
